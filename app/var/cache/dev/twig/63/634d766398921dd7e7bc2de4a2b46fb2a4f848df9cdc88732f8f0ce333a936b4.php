...
class __TwigTemplate_445878f957076ed1f8cd9c6d6fbe9528c9425fa037d0abc2def2758b053b68d8 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        {% for subuser in subusers %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('subuser_crud_show', {'id': subuser.id}) }}\">wyświetl</a>
                    <a href=\"{{ path('subuser_crud_edit', {'id': subuser.id}) }}\">edytuj</a>
                </td>
            </tr>
        {% else %}
            <tr>
