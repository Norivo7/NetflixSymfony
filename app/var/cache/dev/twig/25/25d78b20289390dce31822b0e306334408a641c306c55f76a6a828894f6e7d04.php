...
";
    ...
    <div class=\"row\">
        ...
        // line 19
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["movie"]) || array_key_exists("movie", $context) ? $context["movie"] : (function () { throw new RuntimeError('Variable "movie" does not exist.', 19, $this->source); })()), "link", [], "any", false, false, false, 19), "html", null, true);
        echo "\" frameborder=\"0\"
                ...
                <div class=\"mt-3\">
                    <small>
                        <p>Resume : <br>";
        // line 24
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["movie"]) || array_key_exists("movie", $context) ? $context["movie"] : (function () { throw new RuntimeError('Variable "movie" does not exist.', 24, $this->source); })()), "description", [], "any", false, false, false, 24), "html", null, true);
        echo "</p>
                        <p>
                            Year : ";
        // line 26
        ...
        echo "<br>
                            Category : ";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["movie"]) || array_key_exists("movie", $context) ? $context["movie"] : (function () { throw new RuntimeError('Variable "movie" does not exist.', 28, $this->source); })()), "category", [], "any", false, false, false, 28), "html", null, true);
        echo "
                        </p>
                    </small>
...
";
    ...
    {
        return array (  140 => 32,  136 => 31,  130 => 28,  126 => 27,  122 => 26,  117 => 24,  109 => 19,  105 => 18,  98 => 13,  88 => 12,  76 => 9,  69 => 4,  59 => 3,  36 => 1,);
    }
    ...
    <div class=\"row\">
        ...
        <div class=\"col-8 col-sm-12 text-center\">
            <div class=\"jumbotron jumbotron-dark bg-darkness\">
                ...
                <div class=\"mt-3\">
                    <small>
                        <p>Resume : <br>{{movie.description}}</p>
                        <p>
                            Year : {{movie.year}} <br>
