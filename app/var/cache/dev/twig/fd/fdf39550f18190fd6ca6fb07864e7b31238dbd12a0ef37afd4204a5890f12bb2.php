...
class __TwigTemplate_b5b07cf5aee7316aa4d428f8f4172729cad0119c3d646859453a507f78957c5c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/user_crud/show.html.twig"));
        ...
        $this->parent = $this->loadTemplate("admin/base.html.twig", "admin/user_crud/show.html.twig", 1);
...
";
        ...
        echo "            <tr>
                ...
                <td>";
        // line 30
        echo ((twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 30, $this->source); })()), "isVerified", [], "any", false, false, false, 30)) ? ("Yes") : ("No"));
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a class=\"profileButton\" href=\"";
        // line 37
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_crud_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 37, $this->source); })()), "id", [], "any", false, false, false, 37)]), "html", null, true);
        echo "\">Edytuj</a>
...
{#            </tr>#}
    ...
    <a class=\"profileButton\" href=\"{{ path('app_user_crud_index') }}\">Wróć</a>

    <a class=\"profileButton\" href=\"{{ path('app_user_crud_edit', {'id': user.id}) }}\">Edytuj</a>

    {{ include('admin/user_crud/_delete_form.html.twig') }}
{% endblock %}
", "admin/user_crud/show.html.twig", "/var/www/symfony_docker/templates/admin/user_crud/show.html.twig");
    }
}
