 ...
 */
final class Version20220306160812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE subuser ADD CONSTRAINT FK_5426A4C28F93B6FC FOREIGN KEY (movie_id) REFERENCES movie (id)');
