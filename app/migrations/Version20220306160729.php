 ...
 */
final class Version20220306160729 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD CONSTRAINT FK_1D5EF26FB4622EC2 FOREIGN KEY (liked_by_id) REFERENCES subuser (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
