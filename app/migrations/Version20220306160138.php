 ...
 */
final class Version20220306160138 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD CONSTRAINT FK_1D5EF26F41A33159 FOREIGN KEY (liked_by_subuser_id) REFERENCES subuser (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
